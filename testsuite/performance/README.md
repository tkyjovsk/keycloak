...
- Cross-DC: *Cross-DC functionality is not supported by this version of Keycloak.*
...
To get the connection URLs for `cluster` deployment see the JMX section in the generated `provisioned-system.properties` file.
