...
plot\
    ...
    \
    datafile using 1:(column('S0C')+column('S1C')+column('EC')+column('OC')+column('MC')+column('CCSC')) notitle with lines lc rgb "#000000" lw 1, \
    datafile using 1:(column('S0C')+column('S1C')+column('EC')+column('OC')+column('MC')) notitle with lines lc rgb "#000000" lw 1, \
