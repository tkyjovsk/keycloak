...
public abstract class StringListAttributeTemplate<PE extends Entity>
        extends NestedIndexedEntityTemplate<PE, StringListAttribute<PE>, StringListAttributeRepresentation> {
    ...
    public StringListAttribute<PE> newEntity(PE parentEntity, int index) {
        return new StringListAttribute<>(parentEntity, index, new StringListAttributeRepresentation());
    }
