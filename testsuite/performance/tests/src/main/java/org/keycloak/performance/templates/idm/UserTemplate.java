...
public class UserTemplate extends NestedEntityTemplate<Realm, User> {
    ...
    public UserTemplate(RealmTemplate realmTemplate) {
        ...
        this.usersPerRealm = configuration.getInt("usersPerRealm");
        this.realmRolesPerUser = configuration.getInt("realmRolesPerUser");
        this.clientRolesPerUser = configuration.getInt("clientRolesPerUser");
    }
    ...
    public synchronized User produce(Realm realm, int index) {
        ...
        user.setRealmRoles(new RandomSublist(user.getRealm().getRealmRoles(), user.hashCode(),
                getRealmRolesPerUser()));

        user.setClientRoles(new RandomSublist(user.getRealm().getClientRoles(), user.hashCode(),
                getClientRolesPerUser()));
    ...
    public class UserAttributeTemplate extends StringListAttributeTemplate<User> {
        ...
        public UserAttributeTemplate() {
            ...
            this.attributesPerUser = configuration.getInt("attributesPerUser");
        }
